...
* This version has been updated for use in Raspbian Stretch (as of July 2018 release).
![Stretch Raspbian](https://github.com/marvmex/IoT-RaspiWiFi/blob/master/Configuration%20App/app/assets/images/rstretch.png)
